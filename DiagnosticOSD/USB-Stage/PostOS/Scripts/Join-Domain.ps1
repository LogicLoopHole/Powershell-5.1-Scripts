...
$DomainController = "DC01.Example.Domain"
...
try {
    ...
    Write-Log "Prompting for domain credentials..."
    ...
    # Attempt domain join
    Write-Log "Attempting to join '$DomainName'..."
    $JoinParams = @{
    ...
    try {
        ...
        Write-Log "Successfully joined '$DomainName'" "SUCCESS"
        Remove-AutoLogon
        Remove-TempLocalAdmin
        [System.Windows.Forms.MessageBox]::Show(
